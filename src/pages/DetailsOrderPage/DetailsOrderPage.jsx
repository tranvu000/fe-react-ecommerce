...
import { WrapperAllPrice, WrapperContentInfo, WrapperHeaderUser, WrapperInfoUser, WrapperItem,
  WrapperItemLabel, WrapperLabel, WrapperNameProduct, WrapperProduct, WrapperStyleContent
} from './style';
   ...
   <Loading isLoading={isLoading}>
     <div style={{width: '100%', height: '100vh', background: '#f5f5fa'}}>
      <div style={{ width: '1270px', margin: '0 auto'}}>
        <h3 style={{ fontWeight: 'bold'}}>Chi tiết đơn hàng</h3>
        <WrapperHeaderUser>
          <WrapperInfoUser>
          ...
          {data?.orderItems?.map((order) => {
            return (
              <WrapperProduct>
                ...
                <WrapperItem>{order?.discount ? convertPrice(priceMemo * order?.discount / 100) : '0 vnđ'}</WrapperItem>
              </WrapperProduct>
            )
          })}
          <WrapperAllPrice>
